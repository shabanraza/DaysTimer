...
var DaysTimer = function (_React$Component) {
    ...
    _createClass(DaysTimer, [{
        ...
        value: function renderMatchCounter() {
            ...
            //if we have to close 1 hour before startDate
            var startDate = (0, _moment2.default)(this.props.startDate);

            // let timer = setInterval(function(){
            //if now & startDate are same , means we have to close timer
            if ((0, _moment2.default)(now).isSame(startDate)) {
                window.clearInterval(this.timer);
                this.setState({ close: true });
            }
            if ((0, _moment2.default)(now).isBefore(startDate)) {
                var _now = (0, _moment2.default)();
                var diff = _moment2.default.duration((0, _moment2.default)(startDate).diff((0, _moment2.default)(_now)));
